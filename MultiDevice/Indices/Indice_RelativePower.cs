...
namespace MultiDevice
{
    ...
    class Indice_RelativePower : IndiceToBytes
    {
        ...
        public Indice_RelativePower(List<int> channels_involved)
        {
        ...
        public double[,] Data200ms
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    CalculationDone?.Invoke(this, new MyEventArgs_indice(indices_enu.relative_power));
                }
            }
        }
        ...
        {  
            ...
            else
            {
                ...
                CalculationDone?.Invoke(this, new MyEventArgs_indice(indices_enu.relative_power));
                // LogHelper.Log.LogInfo($"Indice_RelativePower 数据推送:{indices_enu.relative_power}");
            }
        }
        ...
        float[] power_ratio(double[] real, double[] img, int fs)
        {
            ...
            Console.WriteLine("beta:" + ratios[6]);
            return ratios;
        }
