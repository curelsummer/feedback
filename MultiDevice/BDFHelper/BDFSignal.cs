...
namespace BDF
{
    public class BDFSignal
    {
        ...
        public static string NotationLabel = "BDF Annotations";
         ...
         */
        public double AmplifierGain //http://en.wikipedia.org/wiki/Gain 
        {
            get
            {
        ...
        public double SamplePeriodWithinDataRecord { get; set; }
